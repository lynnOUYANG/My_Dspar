...
def main():
    ...
    if model_config['name']=='EbdGNN':
        model = GNN(in_channels=num_features, in_channels2=args.fe_dim,in_channels3=args.se_dim,out_channels=num_classes,device=model_config['device'],sw=args.sw,gnn_type=model_config['gnn_type'],**model_config['architecture'])
    else:
